...
rgbKeyPin = config["rgbKeyPin"] if pinValid(config["rgbKeyPin"]) else None
rgbKeyNumLeds = config["rgbKeyNumLeds"]
rgbKeyOptions = config["rgbKeyOptions"]
if not config["rgbKeyOptions"] and "rgbkey" in kbFeatures:
    print("rgbKeyOptions not set when rgbkey is needed")
