...
export class Keyboard {
  ...
  import({
    ...
    if (this.pogConfigured) {
      ...
      if (configContents.rgbKeyPin) this.rgbKeyPin = configContents.rgbKeyPin
      if (configContents.rgbNumLeds) this.rgbNumLeds = Number(configContents.rgbNumLeds)
      if (configContents.rgbKeyNumLeds) this.rgbKeyNumLeds = Number(configContents.rgbKeyNumLeds)
      if (configContents.rgbOptions) this.rgbOptions = configContents.rgbOptions
      if (configContents.rgbKeyOptions) this.rgbKeyOptions = configContents.rgbKeyOptions
  ...
  serialize() {
    return {
      ...
      rgbPin: this.rgbPin,
      rgbKeyPin: this.rgbKeyPin,
      rgbNumLeds: this.rgbNumLeds,
      rgbKeyNumLeds: this.rgbKeyNumLeds,
      rgbOptions: this.rgbOptions,
      rgbKeyOptions: this.rgbKeyOptions,
